...
public class StringLiteralSet : BaseSet<string>
{
    ...
    public StringLiteralSet(SetsConfigurations extractionConfiguration) : base(extractionConfiguration)
    {
    }
    ...
    public StringLiteralSet(string expression, SetsConfigurations config) : base(expression, config)
    {
    }
    /// <summary>
